...
class ActorCritic(nn.Module):
    ...
    def act(self, obs, device, chunk_size=16):
        ...
        with torch.no_grad():
            ...
            bias_throttle = 0.35  # Sesgo positivo para favorecer la aceleración
            bias_brake = -0.35    # Sesgo negativo para reducir el frenado
...
def train(args):
    ...
    optimizer = optim.Adam([
        {'params': backbone.parameters(), 'lr': args.learning_rate * 0.25},
